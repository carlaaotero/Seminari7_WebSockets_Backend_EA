...
router.delete('/del/:idUser/:idExp', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const data = yield userServices.getEntries.delExperience(req.params.idUser, req.params.idExp);
    return res.json(data);
}));
router.post('/add/:idUser/:idExp', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const data = yield userServices.getEntries.addExperince(req.params.idUser, req.params.idExp);
    return res.json(data);
}));
